<script>
  ...
  import {ContextMenu} from "carbon-components-svelte";
  import Checkmark from "carbon-components-svelte/src/icons/Checkmark.svelte";
  import CaretRight from "carbon-components-svelte/src/icons/CaretRight.svelte";
  ...
  function handleClick(opts = {}, event) {
...
<li
  ...
  on:click="{e=>handleClick(undefined, e)}"
>
  {#if subOptions}
    <div
